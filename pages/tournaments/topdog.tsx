            ...
            <div className="bg-white rounded-xl p-8 shadow-lg">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <h3 className="text-xl font-semibold mb-4" style={{ color: '#1b1b1b' }}>Prize Pool</h3>
                  <p className="text-lg mb-6" style={{ color: '#1b1b1b' }}>$1,000,000</p>
                </div>
              </div>
              ...
              <div className="mt-8 text-center">
                <button
                  ...
                  style={{ backgroundColor: '#59c5bf', color: '#1b1b1b' }}
                >
                  Join Tournament
                </button>
              </div>
