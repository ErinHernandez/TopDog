          ...
          <div className="mt-12 max-w-4xl mx-auto">
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-2">Landmark Detection</h3>
                  <p className="text-gray-600">
                    Identify famous landmarks and locations in images.
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold mb-2">Safe Search</h3>
                  <p className="text-gray-600">
                    Detect adult, violent, racy, or medical content in images.
                  </p>
                </div>
              </div>
            </div>
