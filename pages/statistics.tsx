...
export default function Statistics() {
  ...
  const fetchUserStats = useCallback(async (): Promise<void> => {
    ...
    try {
      ...
      logger.error('Error fetching user stats', error instanceof Error ? error : undefined, {
        userId,
      });
    } finally {
      setLoading(false);
  ...
  return (
    <div
      className="min-h-screen text-white overflow-x-auto"
      style={{
        background: 'url(/wr_blue.png) repeat-y',
        backgroundSize: 'auto 100%',
        backgroundPosition: 'center center',
        ...
        <section className="border-b border-gray-700 bg-white">
          <div className="container mx-auto px-4" style={{ minWidth: '1400px' }}>
            ...
            >
              <Link
                href="/"
                className="font-medium text-base pb-1 transition-colors"
                style={{
                  fontSize: '0.95rem',
              ...
              <div className="bg-white/10 rounded-xl p-6 border border-[#59c5bf]">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span
                      className={`font-bold ${userStats.netProfit >= 0 ? 'text-green-400' : 'text-red-400'}`}
                    >
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-green-400">
                      {formatCurrency(userStats.totalTournamentWinnings)}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/10 rounded-xl p-6 border border-[#59c5bf]">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold">
                      {userStats.averageDraftPosition?.toFixed(1) || 'N/A'}
                    </span>
                  </div>
                  <div className="flex justify-between">
              ...
              <div className="bg-white/10 rounded-xl p-6 border border-[#59c5bf]">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold">
                      {userStats.averageFinish?.toFixed(1) || 'N/A'}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span>Avg Points:</span>
                    <span className="font-bold">
                      {userStats.averagePoints?.toFixed(1) || 'N/A'}
                    </span>
                  </div>
                  <div className="flex justify-between">
            ...
            <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold text-sm">
                        {formatDate(userStats.firstDeposit)}
                      </span>
                    </div>
                    <div className="flex justify-between">
                ...
                <div className="bg-white/10 rounded-xl p-6 border border-[#59c5bf]">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold">
                        {formatCurrency(userStats.totalEntryFees?.total)}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>TopDog Entries:</span>
                      <span className="font-bold">
                        {formatCurrency(userStats.totalEntryFees?.topdog)}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white/10 rounded-xl p-6 border border-[#59c5bf]">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  ...
                  <div className="text-center">
                    <div
                      className={`text-2xl font-bold ${userStats.netProfit >= 0 ? 'text-green-400' : 'text-red-400'}`}
                    >
                      {formatCurrency(userStats.netProfit)}
                    </div>
            ...
            <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold text-yellow-400">
                        {userStats.tournamentResults?.firstPlace || 0}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>2nd Place:</span>
                      <span className="font-bold text-gray-400">
                        {userStats.tournamentResults?.secondPlace || 0}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>3rd Place:</span>
                      <span className="font-bold text-amber-600">
                        {userStats.tournamentResults?.thirdPlace || 0}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>Top 10:</span>
                    ...
                    <div className="flex justify-between">
                      <span>Cashed:</span>
                      <span className="font-bold text-green-400">
                        {userStats.tournamentResults?.cashed || 0}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white/10 rounded-xl p-6 border border-[#59c5bf]">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-green-400">
                      {formatCurrency(userStats.totalWinnings?.topdog)}
                    </div>
            ...
            <div className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-white/10 rounded-xl p-6 border border-[#c4b5fd]">
                  <h3 className="text-xl font-bold mb-4" style={{ color: '#c4b5fd' }}>
                    Players Drafted
                  </h3>
                  <div className="space-y-2">
                ...
                <div className="bg-white/10 rounded-xl p-6 border border-[#c4b5fd]">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      <span>Highest Score:</span>
                      <span className="font-bold">
                        {userStats.highestScore?.toFixed(1) || 'N/A'}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>Lowest Score:</span>
                      <span className="font-bold">
                        {userStats.lowestScore?.toFixed(1) || 'N/A'}
                      </span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      <span>Total Points:</span>
                      <span className="font-bold">
                        {userStats.totalPoints?.toFixed(1) || 'N/A'}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white/10 rounded-xl p-6 border border-[#c4b5fd]">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold">
                        {Math.round((userStats.totalTimeSpent || 0) / 60)} hours
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white/10 rounded-xl p-6 border border-[#c4b5fd]">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold text-sm">
                        {formatDate(userStats.firstTournament)}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>First Win:</span>
