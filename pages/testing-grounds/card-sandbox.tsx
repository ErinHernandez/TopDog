...
function formatPickDisplay(pickNumber: number, teamCount: number = 12): string {
...
function getPositionCounts(picks: Position[]): PositionCount[] {
...
export default function CardSandbox(): JSX.Element {
  return (
    <div style={{ 
