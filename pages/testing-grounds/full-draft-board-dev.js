...
export default function FullDraftBoardDev() {
  ...
  const [isRoomOwner, setIsRoomOwner] = useState(true); // For testing purposes
  ...
  const mockDrafters = ['User', 'Mock1', 'Mock2', 'Mock3', 'Mock4', 'Mock5', 'Mock6', 'Mock7', 'Mock8', 'Mock9', 'Mock10', 'Mock11'];
