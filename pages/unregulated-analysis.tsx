...
type SortBy = 'state' | 'regNumber' | 'regulationLevel' | 'applicationCost' | 'licenseCost' | 'renewalCost' | 'taxRate';
                ...
                return (
                  <g key={abbreviation}>
                    <path
                      ...
                      onClick={() => setSelectedState(selectedState === abbreviation ? null : abbreviation as StateAbbreviation)}
                    />
                    {isHovered && (
                      <text
                        x="400"
