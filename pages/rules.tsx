  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white py-12 px-4 max-w-3xl mx-auto">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-2 text-primary">General Contest Information</h2>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-2 text-primary">Rounds</h2>
        <ul className="list-disc ml-6 mb-2 text-gray-200">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-2 text-primary">Roster Makeup</h2>
        <ul className="list-disc ml-6 mb-2 text-gray-200">
          <li>QB: 1</li>
          <li>RB: 2</li>
          <li>WR: 3</li>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-2 text-primary">Prize Pool</h2>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-2 text-primary">Maximum Entries</h2>
        <p className="mb-2 text-gray-200">This Tournament will have a maximum of 150 entries per entrant.</p>
      </section>
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-2 text-primary">Scoring</h2>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-2 text-primary">Ties &amp; Advancement</h2>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-2 text-primary">Multiple Entries</h2>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-2 text-primary">Slow Drafts</h2>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-2 text-primary">Guaranteed Contest</h2>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-2 text-primary">Eligibility & Accounts</h2>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-2 text-primary">Lineup Restrictions & Edits</h2>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-2 text-primary">Contest Cancellation</h2>
