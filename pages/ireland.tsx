...
interface IrelandData {
  ...
  media: {
    nflViewership: number;
    americanTvViewership: number;
    streamingPenetration: number;
  ...
  sports: {
    ...
    leagues: {
      nfl: { presence: boolean; viewership: number; localTeams: string[]; fanBase: number };
      nba: { presence: boolean; viewership: number; localTeams: string[]; fanBase: number };
      mlb: { presence: boolean; viewership: number; localTeams: string[]; fanBase: number };
      nhl: { presence: boolean; viewership: number; localTeams: string[]; fanBase: number };
      mls: { presence: boolean; viewership: number; localTeams: string[]; fanBase: number };
    };
    fantasySports: {
    ...
    gambling: {
      sportsBetting: { legal: boolean; popularity: number; marketSize: number };
      dailyFantasy: { legal: boolean; popularity: number; marketSize: number };
      traditionalFantasy: { legal: boolean; popularity: number; marketSize: number };
    };
    events: {
      majorEvents: string[];
      localEvents: string[];
  ...
  religion: {
    demographics: {
      ...
      religiousDistribution: Array<{
        religion: string;
        percentage: number;
        population: number;
        notes: string;
      }>;
      secularizationLevel: string;
      religiousFreedom: string;
      stateReligion: boolean;
      stateReligionName: string;
      notes: string;
    };
    gamblingAttitudes: {
      religiousRestrictions: string[];
      gamblingProhibitions: string[];
      religiousOpinions: {
        generalGambling: string;
      ...
      culturalFactors: {
        gamblingStigma: number;
        skillGameAcceptance: number;
    ...
    businessImplications: {
      marketingSensitivity: string[];
      acceptableImagery: string[];
    ...
    legalFramework: {
      religiousLaws: string[];
      blasphemyLaws: boolean;
      religiousCensorship: boolean;
      religiousTaxation: boolean;
      notes: string;
    };
  };
  compliance: {
...
export default function IrelandPage() {
  const [irelandData] = useState<IrelandData>({
    id: 'ireland-2024',
    name: 'Ireland',
    country: 'Ireland',
    state: '',
