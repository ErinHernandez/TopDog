...
export default function ComponentSandbox() {
  const [selectedComponent, setSelectedComponent] = useState('PlayerExpandedCard');
  const [selectedPlayer, setSelectedPlayer] = useState('rb');
            ...
            {selectedComponent === 'PlayerExpandedCard' && (
              <>
                ...
                <div style={{
                  ...
                  <PlayerExpandedCard
                    player={SAMPLE_PLAYERS[selectedPlayer]}
...
function PropDoc({ name, type, required, description }) {
  return (
