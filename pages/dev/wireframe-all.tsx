...
// ============================================================================
// Single Screen with Annotations Component
// ============================================================================
...
const ScreenWithAnnotations: React.FC<ScreenWithAnnotationsProps> = ({ screen }) => {
...
export default function WireframeAllPage() {
  return (
    <>
      <Head>
        <title>All Wireframes - TopDog iOS</title>
      </Head>
      ...
      <div style={{ minHeight: '100vh', background: MCM.bg, color: MCM.text, fontFamily: 'system-ui, -apple-system, sans-serif' }}>
        ...
        <header style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 24px', background: MCM.surface, borderBottom: `1px solid ${MCM.line}` }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 10, fontWeight: 500, color: MCM.textMuted }}>All iOS Wireframes</div>
            </div>
          </div>
        ...
        {/* ===== ALL WIREFRAMES IN ONE COLUMN ===== */}
        <main style={{ padding: '32px 0' }}>
          {screens.map((screen) => (
            <ScreenWithAnnotations key={screen.title} screen={screen} />
          ))}
        </main>
        ...
        >
          TopDog iOS • {screens.length} Screens • Mid-Century Modern Design System
        </footer>
      </div>
    </>
  );
