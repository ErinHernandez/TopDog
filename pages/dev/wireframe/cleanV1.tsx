...
// ============================================================================
// Mid-Century Modern Design System (MCM) — Original V1
// ============================================================================
...
// ============================================================================
// Annotation Labels — SVG Dashed Lines (Original V1 layout)
// ============================================================================
...
export default function WireframeCleanV1() {
  const [selectedIndex, setSelectedIndex] = useState(0);
  const [showAnnotations, setShowAnnotations] = useState(true);

  // Original V1 fixed layout — never changes
  ...
  return (
    <>
      <Head>
        <title>TopDog iOS Wireframes — Clean V1</title>
      </Head>
      ...
      >
        ...
        >
          TopDog iOS • Mid-Century Modern Design System • {screens.length} Screens
        </footer>
      </div>
    </>
  );
