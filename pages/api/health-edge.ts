...
import { withEdgeErrorHandling, type RequestWithGeo } from '@/lib/edgeErrorHandler';
...
async function handler(req: NextRequest): Promise<Response> {
  ...
  // Get edge region info (Vercel adds geo at runtime)
  const geo = (req as RequestWithGeo).geo;
