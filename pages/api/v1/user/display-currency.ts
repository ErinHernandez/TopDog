...
// Export with authentication, CSRF protection (for PUT/DELETE), and rate limiting
...
export default withCSRFProtection(
  withAuth(
    withRateLimit(handler, displayCurrencyLimiter) as unknown as AuthApiHandler,
