...
export default async function handler(
  ...
  try {
    ...
    if (payload.payment_id && payload.callback_virtual_account_id) {
      ...
      console.log('[Xendit Webhook] Processing VA payment', {
      ...
      // E-wallet capture
      console.log('[Xendit Webhook] Processing e-wallet capture', {
        chargeId: payload.id,
      ...
      console.log('[Xendit Webhook] Processing disbursement', {
