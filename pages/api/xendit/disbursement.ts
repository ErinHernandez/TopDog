...
import { withAuth, type ApiHandler } from '../../../lib/apiAuth';
import { 
  withErrorHandling,
  validateMethod,
  validateBody,
...
// withRateLimit returns (NextApiRequest, res) => ...; withAuth expects ApiHandler (AuthenticatedRequest, res)
export default withAuth(
  withRateLimit(handler, xenditDisbursementLimiter) as ApiHandler,
