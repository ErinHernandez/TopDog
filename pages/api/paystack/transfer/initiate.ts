...
// Create rate limiter for Paystack transfers (5 per hour)
const paystackTransferLimiter = createPaymentRateLimiter('paystackTransfer');
...
export default withCSRFProtection(
  withRateLimit(handler, paystackTransferLimiter) as unknown as CSRFHandler
);
