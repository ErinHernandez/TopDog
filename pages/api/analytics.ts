...
async function verifyAuth(authHeader: string | undefined): Promise<AuthResult> {
  ...
  // If Firebase Admin is not initialized (e.g. local dev without service account), reject without logging a stack
  if (!firebaseAdminInitialized) {
    logger.warn('Firebase Admin not initialized - cannot verify tokens', {
      component: 'analytics',
