...
import { toSmallestUnit, toDisplayAmount, getCurrencyConfig } from '../stripe/currencyConfig';
...
/**
 * Convert smallest unit to PayPal amount format (string with appropriate decimal places)
 *
 * @param smallestUnit - Amount in smallest unit (e.g., cents for USD)
 * @param currency - Currency code (defaults to 'USD' for backward compatibility)
 * @returns Amount as string with appropriate decimal places
 */
export function centsToPayPalAmount(smallestUnit: number, currency: string = 'USD'): string {
...
/**
 * Convert PayPal amount string to smallest unit
 *
 * @param amount - Amount as string from PayPal
 * @param currency - Currency code (defaults to 'USD' for backward compatibility)
 * @returns Amount in smallest unit (e.g., cents for USD)
 */
export function paypalAmountToCents(amount: string, currency: string = 'USD'): number {
  return toSmallestUnit(parseFloat(amount), currency);
}
