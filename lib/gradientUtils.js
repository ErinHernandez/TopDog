...
export const createTeamGradient = (team) => {
  ...
  // Create corner-to-corner gradient (top-right to bottom-left) with primary color on edges, secondary in center
  const diagonalGradient = `linear-gradient(225deg, ${primaryColor} 0%, ${secondaryColor} 50%, ${primaryColor} 100%)`;
