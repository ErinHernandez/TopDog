...
export const createTeamGradient = (team) => {
  ...
  // Create corner-to-corner gradient (top-right to bottom-left) with secondary color on edges, primary in center
  const diagonalGradient = `linear-gradient(225deg, ${secondaryColor} 0%, ${primaryColor} 50%, ${secondaryColor} 100%)`;
