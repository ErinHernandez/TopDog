...
export const tournamentTemplates = {
  ...
  bigdog: {
    name: 'the BIGDog',
    description: 'High-stakes SuperFlex fantasy football tournament',
    entryFee: 250,
    maxEntries: 1000,
    prizePool: 150000,
    format: 'SuperFlex Best Ball',
    leagueSize: 12,
    status: 'development',
    features: ['superflex', 'snake-draft', 'best-ball', 'auto-lineup', 'tournament-advancement'],
    notes: 'Moved to development for testing and refinement. SuperFlex format requires additional testing.',
    scoring: {
      reception: 0.5,
      receivingTD: 6.0,
      receivingYard: 0.1,
  ...
  bottomdog: {
    name: 'the bottomDog',
    description: 'Affordable entry-level fantasy football tournament',
    entryFee: 5,
    maxEntries: 1000,
    prizePool: 600,
    format: 'Best Ball',
    ...
    status: 'development',
    features: ['snake-draft', 'best-ball', 'auto-lineup', 'tournament-advancement'],
    notes: 'Moved to development for testing and refinement. Entry-level tournament requires additional validation.',
    scoring: {
      reception: 0.5,
      receivingTD: 6.0,
      receivingYard: 0.1,
...
export const devTournamentTemplates = {
  bigdog: {
    ...
    status: 'development',
    features: ['superflex', 'snake-draft', 'best-ball', 'auto-lineup', 'tournament-advancement'],
    notes: 'Moved to development for testing and refinement. SuperFlex format requires additional testing and player pool validation.',
    scoring: {
      reception: 0.5,
      receivingTD: 6.0,
      receivingYard: 0.1,
  ...
  bottomdog: {
    ...
    status: 'development',
    features: ['snake-draft', 'best-ball', 'auto-lineup', 'tournament-advancement'],
    notes: 'Moved to development for testing and refinement. Entry-level tournament requires additional validation and user experience testing.',
    scoring: {
      reception: 0.5,
      receivingTD: 6.0,
      receivingYard: 0.1,
