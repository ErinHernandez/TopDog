...
/** Vercel Edge adds geo to the request at runtime (not in NextRequest types). Export for use in health-edge etc. */
export interface RequestWithGeo extends NextRequest {
  geo?: { region?: string; city?: string };
}
