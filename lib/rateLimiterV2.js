...
class InMemoryRateLimitStore {
   ...
   */
  increment(key, windowEnd, maxRequests) {
...
export class RateLimiterV2 {
   ...
   */
  calculateEffectiveLimit(clientId, baseLimit) {
    let limit = baseLimit;
   ...
   */
  async checkAllLevels(clientId, effectiveLimit, windowEnd) {
    const checks = {};
   ...
   */
  selectMostRestrictive(checks, effectiveLimit, windowEnd) {
 ...
 */
export function createProgressiveRateLimiter(config) {
