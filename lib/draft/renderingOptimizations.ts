      ...
      filtered.sort((a, b) => {
        ...
        switch (sortBy) {
          ...
          case 'rankings':
            ...
            aValue = (a as { customRanking?: number }).customRanking || a.adp || 999;
            bValue = (b as { customRanking?: number }).customRanking || b.adp || 999;
            break;
          case 'name':
          ...
          case 'team':
            ...
            break;
          default:
            aValue = (a as Record<string, unknown>)[sortBy] as number || 0;
            bValue = (b as Record<string, unknown>)[sortBy] as number || 0;
        }
