...
export interface DropdownContentStyle {
  className: string;
  getStyle: (player: { team: string }) => React.CSSProperties;
}

export interface PlayerNameStyle {
  className: string;
  style: React.CSSProperties;
}

export interface PlayerInfoStyle {
  className: string;
  style: React.CSSProperties;
}

export interface RankColumnStyle {
  className: string;
  style: React.CSSProperties;
}
...
export interface ButtonStyle {
  className: string;
  getStyle?: (isMyTurn?: boolean) => React.CSSProperties;
  style?: React.CSSProperties;
}
...
export interface DropdownStyles {
  PLAYER_ROW: PlayerRowStyle;
  DROPDOWN_CONTENT: DropdownContentStyle;
  PLAYER_NAME: PlayerNameStyle;
  PLAYER_INFO: PlayerInfoStyle;
  RANK_COLUMN: RankColumnStyle;
  ADP_DISPLAY: DisplayStyle;
  PROJECTION_DISPLAY: DisplayStyle;
  DRAFT_BUTTON: ButtonStyle;
  QUEUE_BUTTON: ButtonStyle;
  STATS_HEADER: StatsStyle;
  STATS_ROW: StatsStyle;
}
...
export interface DropdownAnimations {
...
export interface ContextOverrides {
  DRAFT_ROOM: ContextConfig;
  TEAM_MANAGEMENT: ContextConfig;
  RANKINGS: ContextConfig;
  MOBILE_DRAFT: ContextConfig;
}
...
export const DROPDOWN_STYLES: DropdownStyles = {
...
export const DROPDOWN_ANIMATIONS: DropdownAnimations = {
...
export const POSITION_STYLES: PositionStyles = {
  QB: {
    borderColor: '#F472B6',
...
export const CONTEXT_OVERRIDES: ContextOverrides = {
  // Draft room context
  DRAFT_ROOM: {
