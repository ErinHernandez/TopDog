 ...
 * Colors from core/constants/colors (UI_COLORS.tiledBg, LOBBY_THEME.progressBg).
 *
 * @module cardSpacingV3
 */

import { UI_COLORS, LOBBY_THEME } from '../../../core/constants/colors';
...
export const CARD_SPACING_V3 = {
  ...
  /** Border color for featured cards (from UI_COLORS.tiledBg) */
  borderColor: UI_COLORS.tiledBg,
  ...
  /** Progress bar background color (from LOBBY_THEME.progressBg) */
  progressBackgroundColor: LOBBY_THEME.progressBg,
