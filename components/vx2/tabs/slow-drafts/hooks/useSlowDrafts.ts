...
function generateMockSlowDraft(index: number): SlowDraft {
  ...
  return {
    ...
    tournamentName: [
      ...
      'TopDog International IV',
      'TopDog International V',
      'TopDog International VI',
      'TopDog International VII',
      'TopDog International VIII',
    ][index % 8],
    teamId: `team-${index}`,
    teamName: `Team ${['I', 'II', 'III', 'IV', 'V', 'VI', 'VII', 'VIII', 'IX', 'X', 'XI', 'XII'][(index % 12)]}`,
