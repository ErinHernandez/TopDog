...
import { TEXT_COLORS, BG_COLORS } from '../../core/constants/colors';
        ...
        <div className="mt-6">
          <button
            ...
            className={cn(
              ...
              canContinue ? styles.primaryButtonEnabled : styles.primaryButtonDisabled
            )}
          >
            Continue
          </button>
...
function UsernameStep({
  ...
  return (
    <div className="flex flex-col h-full" onKeyDown={handleKeyDown}>
      ...
      >
        <div className="text-center mb-8">
          <div className={styles.iconCircle}>
            <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke={TEXT_COLORS.primary} strokeWidth="2">
      ...
      {/* Footer */}
      <div className={cn(styles.footer, styles.footerWithBorder)}>
        <button
          onClick={onContinue}
          disabled={!canContinue}
          className={cn(
  ...
  return (
    <div className="flex flex-col h-full" onKeyDown={handleKeyDown}>
      ...
      >
        <div className="text-center mb-8">
          <div className={styles.iconCircle}>
            <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke={BG_COLORS.black} strokeWidth="2">
        ...
        {(error || verifyError) && (
          <div className={styles.errorBanner}>
            ...
            <span className={styles.errorBannerText}>{error || verifyError}</span>
          </div>
        )}
        ...
        <p className={cn(styles.textMuted, "text-center mt-6", styles.resendHintText)}>
          ...
          {cooldownActive ? (
            ...
            <button
              ...
              disabled={isLoading}
              className={cn(styles.gradientText, "font-semibold")}
            >
              resend code
            </button>
          )}
...
function SuccessStep({ email, username, onClose }: SuccessStepProps): React.ReactElement {
  return (
    ...
    >
      ...
      <button
        onClick={onClose}
        className={cn(styles.primaryButton, styles.primaryButtonEnabled)}
      >
        Get Started
      </button>
    </div>
