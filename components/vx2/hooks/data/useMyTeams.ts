...
import type { MyTeam, TeamPlayer, UseMyTeamsResult, Position } from './useMyTeams.types';

// Re-export types for consumers
export type { MyTeam, TeamPlayer, UseMyTeamsResult, Position } from './useMyTeams.types';
