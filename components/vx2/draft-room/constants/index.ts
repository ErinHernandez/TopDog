...
import { STATE_COLORS, POSITION_COLORS, BG_COLORS, TEXT_COLORS, UI_COLORS } from '../../core/constants/colors';
...
/**
 * LocalStorage key for tutorial disabled flag
 */
export const TUTORIAL_DISABLED_KEY = 'topdog_tutorial_disabled';

/**
 * LocalStorage key prefix for per-draft tutorial shown flag
 */
export const TUTORIAL_SHOWN_PREFIX = 'topdog_tutorial_shown_';

/**
 * LocalStorage key for draft alerts prompt seen flag
 */
export const DRAFT_ALERTS_PROMPT_SEEN_KEY = 'topdog_draft_alerts_prompt_seen';
...
export const TILED_BG_STYLE = {
  ...
  backgroundColor: UI_COLORS.tiledBg,
} as const;
...
export const TILED_BG_CSS = `
  ...
  background-color: ${UI_COLORS.tiledBg};
`;
