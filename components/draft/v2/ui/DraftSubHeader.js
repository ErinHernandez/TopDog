/**
 * DraftSubHeader - V2 Draft Room Specific Blue Gradient Bars
 * 
 ...
 * 
 * Changes to this component will ONLY affect V2 draft rooms.
 */
...
const DraftSubHeader = ({ 
  ...
  return (
    <section 
      className={`draft-v2-subheader zoom-resistant ${className}`}
      style={{ 
        height: height,
        width: '100vw', 
