...
const DEFAULT_LINKS = [
  ...
  { id: 'wireframe', href: '/dev/wireframe', label: 'iOS Wireframe', bgColor: '#7C2D12', bgColorActive: '#9A3412', textColor: '#FDBA74' },
  { id: 'extraction', href: '/dev/extraction', label: 'Screenshot → Swift', bgColor: '#7C2D12', bgColorActive: '#9A3412', textColor: '#FDBA74' },
  // Glossary Admin Tools
  { id: 'glossary-admin', href: '/glossary/admin', label: 'Glossary Admin', bgColor: '#1E3A8A', bgColorActive: '#1E40AF', textColor: '#93C5FD' },
  { id: 'screenshot-depot', href: '/glossary/admin/screenshot-depot', label: 'Screenshot Depot', bgColor: '#1E3A8A', bgColorActive: '#1E40AF', textColor: '#93C5FD' },
  { id: 'element-extractor', href: '/glossary/admin/element-extractor', label: 'Element Extractor', bgColor: '#1E3A8A', bgColorActive: '#1E40AF', textColor: '#93C5FD' },
  { id: 'cleaned-elements', href: '/glossary/admin/cleaned-elements', label: 'Cleaned Elements', bgColor: '#1E3A8A', bgColorActive: '#1E40AF', textColor: '#93C5FD' },
];
